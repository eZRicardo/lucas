...
$id = $_GET['id'];
$dataDesassociacao = date("d/m/Y",strtotime($_GET['data']));



$sql = "SELECT A.nome as nome, E.nome as engenharia, S.nome as setor,A.data_associacao as data_associacao FROM associado A
...
function Header()
{
    ...
    // Title
		$this->Ln(10);
		$this->Cell(100);
    $this->Cell(15,5,'Empresa Junior de Engenharia da Escola Politecnica de Pernambuco DESASSOCIACAO',0,0,'C');
    // Line break
    $this->Ln(20);
}
...
$pdf->Ln(5);
$pdf->Cell(40,10,'Data: ');
$pdf->Cell(40,10,$dataDesassociacao);
$pdf->Ln(5);
...
$pdf->Cell(40,10,$setor);
$pdf->Cell(40,10,'Data de associação: ');
$pdf->Ln(5);
$pdf->Cell(40,10, $data_associacao);
$pdf->Ln(5);
